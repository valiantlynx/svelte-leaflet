<script>
  ...
  <div class="mb-8">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
      <code class="p-2 border rounded">latLngBounds | Geographical bounds.    | LatLngBounds</code>
    ...
    <table class="w-full">
      ...
      <tbody>
        <tr>
          <td class="border p-2">getRectangle()</td>
          <td class="border p-2">
            Returns the underlying Leaflet <code>Rectangle</code> object instance.
            See <a href="https://leafletjs.com/reference.html#rectangle" target="_blank">https://leafletjs.com/reference.html#rectangle</a>
          </td>
        </tr>
      </tbody>
    </table>
