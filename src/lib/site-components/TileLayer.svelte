...
<div class="mb-8">
	...
	<div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
		...
		<code class="p-2 border rounded"
			>wms | If true, the layer will be created using `L.tileLayer.WMS()`. | Boolean</code
		>
	...
	<table class="w-full">
		...
		<tbody>
			<tr>
				...
				<td class="border p-2"
					>Returns the underlying Leaflet <code>TileLayer</code> object instance. See
					<a href="https://leafletjs.com/reference.html#tilelayer" target="_blank"
						>https://leafletjs.com/reference.html#tilelayer</a
					></td
				>
			</tr>
		</tbody>
