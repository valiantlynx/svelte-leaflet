<script>
  ...
  <div class="mb-8">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
      ...
      <code class="p-2 border rounded">radius      | Radius in meters.       | Number</code>
    ...
    <table class="w-full">
      ...
      <tbody>
        <tr>
          <td class="border p-2">getCircle()</td>
          <td class="border p-2">
            Returns the underlying Leaflet <code>Circle</code> object instance.
            See <a href="https://leafletjs.com/reference.html#circle" target="_blank">https://leafletjs.com/reference.html#circle</a>
          </td>
        </tr>
      </tbody>
    </table>
