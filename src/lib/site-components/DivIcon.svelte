<script>
  ...
  <div class="mb-8">
    <h1 class="text-4xl font-bold mb-4">Marker / DivIcon Component</h1>
    ...
    <table class="w-full">
      ...
      <tbody>
        <tr>
          ...
          <td class="border p-2">Returns the underlying Leaflet <code>Icon</code> object instance. See <a href="https://leafletjs.com/reference.html#icon" target="_blank">https://leafletjs.com/reference.html#icon</a></td>
        </tr>
      </tbody>
    </table>
  </div>
