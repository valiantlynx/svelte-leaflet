...
<div class="mb-8">
	<h1 class="text-4xl font-bold mb-4">Popup Component</h1>
	...
	<table class="w-full">
		...
		<tbody>
			<tr>
				<td class="border p-2">getPopup()</td>
				<td class="border p-2"
					>Returns the underlying Leaflet <code>Popup</code> object instance. See
					<a href="https://leafletjs.com/reference.html#popup" target="_blank"
						>https://leafletjs.com/reference.html#popup</a
					></td
				>
			</tr>
		</tbody>
