    ...
    <table class="w-full">
      ...
      <tbody>
        <tr>
          ...
          <td class="border p-2">
            Returns the underlying Leaflet <code>GeoJSON</code> object instance.
            See <a href="https://leafletjs.com/reference.html#geojson" target="_blank">https://leafletjs.com/reference.html#geojson</a>
          </td>
        </tr>
      </tbody>
    </table>
