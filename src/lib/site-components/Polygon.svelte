	...
	<table class="w-full">
		...
		<tbody>
			<tr>
				...
				<td class="border p-2">
					Returns the underlying Leaflet <code>Polygon</code> object instance. See
					<a href="https://leafletjs.com/reference.html#polygon" target="_blank"
						>https://leafletjs.com/reference.html#polygon</a
					>
				</td>
			</tr>
		</tbody>
