<script>
  ...
  <div class="mb-8">
    <h1 class="text-4xl font-bold mb-4">Polygon Component</h1>
    <h2 class="text-2xl font-semibold mb-4">Basic Usage</h2>
    <div class="mb-4 h-96">
      <LeafletMap options={mapOptions}>
        <TileLayer url={tileUrl} options={tileLayerOptions} />
        <Polygon
          bind:this={polygonInstance1}
          latLngs={polygon1}
          color="#ff0000"
          fillColor="#ff0000"
        >
    ...
    <table class="w-full">
      ...
      <tbody>
        <tr>
          <td class="border p-2">getPolygon()</td>
          <td class="border p-2">
            Returns the underlying Leaflet <code>Polygon</code> object instance.
            See <a href="https://leafletjs.com/reference.html#polygon" target="_blank">https://leafletjs.com/reference.html#polygon</a>
          </td>
        </tr>
      </tbody>
    </table>
