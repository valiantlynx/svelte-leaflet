...
<div class="mb-8">
	...
	<div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
		<code class="p-2 border rounded">position | Position. | String('topright')</code>
	...
	<table class="w-full">
		...
		<tbody>
			<tr>
				<td class="border p-2">getScaleControl()</td>
				<td class="border p-2">
					Returns the underlying Leaflet <code>Control.Scale</code> object instance. See
					<a href="https://leafletjs.com/reference.html#control-scale" target="_blank"
						>https://leafletjs.com/reference.html#control-scale</a
					>
				</td>
			</tr>
		</tbody>
