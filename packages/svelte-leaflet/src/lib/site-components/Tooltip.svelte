...
<div class="mb-8">
	<h1 class="text-4xl font-bold mb-4">Tooltip Component</h1>
	...
	<table class="w-full">
		...
		<tbody>
			<tr>
				<td class="border p-2">getTooltip()</td>
				<td class="border p-2"
					>Returns the underlying Leaflet <code>Tooltip</code> object instance. See
					<a href="https://leafletjs.com/reference.html#tooltip" target="_blank"
						>https://leafletjs.com/reference.html#tooltip</a
					></td
				>
			</tr>
		</tbody>
